...
<Main>
  <Section>
    ...
    <p>
      Assuming you are using win32 to create a window and would like to call <var
        >give_me_a_buffer_to_draw_to()</var
      >, here's
      <BlankLink
    ...
    <p>
      I've compiled it with <var>clang++ main.cpp -luser32 -lgdi32</var>, you
    ...
    <ul>
      <li>
        It repaints the bitmap every frame. The snippets I've seen from the
      ...
      <li>
        I wasn't sure how to handle minimizing a window so it just loops until
        it's not minimized.
      </li>
      <li>
        The <var>resizeBitmap()</var> function is quite overloaded and not properly
      ...
      <li>
        ...
        alignment and some additional info on the <BlankLink
    ...
    <blockquote>
      The code looks straightforward and relatively simple. It creates a window
